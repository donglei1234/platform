...
var (
	...
	InvalidAppId      = status.Error(codes.InvalidArgument, "InvalidAppId")
	ErrCanceled       = status.Error(codes.Canceled, "ClientCanceled")
	ErrJoinGame       = status.Error(codes.Unknown, "ErrJoinGameFailure")
	ErrInvalidArg     = status.Error(codes.InvalidArgument, "ErrInvalidArg")
)
