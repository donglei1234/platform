...
func testConnectionMuxFactory(t *testing.T) (mux *TcpConnectionMux, err error) {
...
// @TODO: PBAUMAN: Keep or remove test based on whether or not we are keeping these in cmux.go. Issue #479
